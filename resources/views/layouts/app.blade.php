...
<head>
    ...
    <!-- Title -->
    <title>Dashboard Admin - Neptunus</title>
            ...
            <div class="logo">
                ...
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        ...
                        <span class="user-info-text">Administrator<br><span class="user-state-info">Administrator</span></span>
                    </a>
                </div>
            </div>
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="active-page">
                        <a href="{{ route('admin.data-alumni') }}" class="active"><i class="material-icons-two-tone">people</i>Data Alumni</a>
                    </li>
                </ul>
            </div>
        </div>
